...
public class MarsRoverApiService {
    ...
    public MarsRoverApiResponse getRoverData(String roverType) {
        ...
        ResponseEntity<MarsRoverApiResponse> response = rt.getForEntity("https://api.nasa.gov/mars-photos/api/v1/rovers/" + roverType + "/photos?sol=100&api_key=" + API_KEY, MarsRoverApiResponse.class);
